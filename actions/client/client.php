...
require_once '../hours_count_connection.php';
...
<head>
    ...
    <title>Gestión de Clientes | HOURS COUNT</title>
...
<body>
        ...
        <div class="brand">
            <a href="../../index.php">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="5 5 40 40" width="44" height="44">
                    <circle cx="25" cy="25" r="18" stroke="white" stroke-width="3" fill="none" stroke-dasharray="85 28"
            ...
            <form method="POST" action="./addService.php" id="assignServiceForm">
                <div class="form-grid">
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        ...
                        <div
                            style="max-height: 300px; overflow-y: auto; border: 1px solid #e2e8f0; border-radius: 6px; background: #f8fafc;">
                ...
                <tbody>
                    <?php foreach ($client_services as $client): ?>
                        <tr data-id="<?= $client['id'] ?>" data-name="<?= htmlspecialchars($client['name'], ENT_QUOTES) ?>"
                            ...
                            <td><code
                                    style="background:#f1f5f9; padding:4px 8px; border-radius:4px; font-weight:600;"><?= htmlspecialchars($client['cif']) ?></code>
                            </td>
                            <td>
                                <div class="service-list">
                                    <?php if (empty($client['services'])): ?>
                                        <span style="color:#cbd5e1; font-style:italic; font-size:0.8rem;">
                                    ...
                                    <?php else: ?>
                                        ...
                                        ?>
                                        <div class="service-item" style="border-left: 4px solid var(--success); background: #f0fdf4; font-weight: 700; margin-top: 8px;">
                                            TOTAL:
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <h3
                style="color:var(--brand-primary); margin-top:0; font-weight:800; border-bottom:2px solid #f1f5f9; padding-bottom:15px;">
            ...
            <form id="editClientForm">
                ...
                <h4
                    style="color:#64748b; font-size:0.8rem; text-transform:uppercase; letter-spacing:1px; margin-bottom:15px;">
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content" style="max-width: 450px; text-align: center; padding: 30px;">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <p style="color: #64748b; margin: 0; font-size: 0.95rem; line-height: 1.5;">Estás a punto de eliminar a <strong id="deleteClientName" style="color: #1a202c;"></strong>.<br>Esta acción borrará también sus servicios asociados.</p>
            </div>
            <form id="deleteClientForm" method="POST" action="./deleteClient.php">
                ...
                <div style="display: flex; gap: 10px; justify-content: center; margin-top: 25px;">
                    ...
                    <button type="submit" style="background: #dc2626; border: none; color: white; padding: 12px 24px; border-radius: 8px; font-weight: 700; cursor: pointer; transition: 0.2s; box-shadow: 0 4px 6px rgba(220, 38, 38, 0.2);">Sí, eliminar</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('assignServiceForm').addEventListener('submit', function (e) {
            ...
            selectedServices.forEach(checkbox => {
                ...
                // Resetear bordes
                priceMonth.style.border = '1px solid #e2e8f0';
                priceHour.style.border = '1px solid #e2e8f0';
