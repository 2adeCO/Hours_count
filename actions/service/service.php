...
<head>
    ...
    <title>Gestión de Servicios | HOURS COUNT</title>
    ...
    <style>
        ...
        /* ACCIONES */
        .btn-action {
            background: transparent; border: 1px solid #e2e8f0; padding: 6px 10px; border-radius: 4px;
            font-size: 0.75rem; font-weight: 700; cursor: pointer; transition: 0.2s;
            display: inline-flex; align-items: center; gap: 5px;
        }
        .btn-edit { color: var(--brand-primary); }
        .btn-edit:hover { background: var(--brand-primary); color: white; border-color: var(--brand-primary); }
    ...
    <a href="../../index.php">
        ...
        <div class="header-right">
            <div class="user-info">
                ...
                <div class="role">Gestion de servicios</div>
            </div>
