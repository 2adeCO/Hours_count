...
<head>
    ...
    <title>Gestión de Usuarios | HOURS COUNT</title>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content" style="max-width: 450px; text-align: center; padding: 30px;">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <p style="color: #64748b; margin: 0; font-size: 0.95rem; line-height: 1.5;">Estás a punto de eliminar a <strong id="deleteUserName" style="color: #1a202c;"></strong>.<br>Esta acción es irreversible.</p>
            </div>
            <div style="display: flex; gap: 10px; justify-content: center; margin-top: 25px;">
                <button type="button" onclick="closeDeleteModal()" style="background: white; border: 1px solid #e2e8f0; color: #4a5568; padding: 12px 24px; border-radius: 8px; font-weight: 700; cursor: pointer; transition: 0.2s; width: auto; margin-top: 0;">Cancelar</button>
